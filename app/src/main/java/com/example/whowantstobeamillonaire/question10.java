...
public class question10 extends AppCompatActivity {
    ...
    private TextView mscore, mquestion10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mscore.setText(getIntent().getStringExtra("YOU EARNED: $5,00,000"));
        mquestion10=(TextView)findViewById(R.id.question10);
        ...
        mconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(manswer3.isChecked()){
                    ...
                    mscore.setText("YOU EARNED: $10,00,000");

                    Toast.makeText(getApplicationContext(), "Correct answer", Toast.LENGTH_LONG).show();
                    String scr=mscore.getText().toString();
                    Intent intent = new Intent(question10.this,winner.class);

                    intent.putExtra("YOU EARNED: $10,00,000",scr);
                    ...
                    Intent intent = new Intent(question10.this,gameOver.class);
                    String scr=mscore.getText().toString();
