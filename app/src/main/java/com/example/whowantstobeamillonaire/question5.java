...
public class question5 extends AppCompatActivity {
    ...
    private TextView mscore, mquestion5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mscore.setText(getIntent().getStringExtra("YOU EARNED: $1000"));
        mquestion5=(TextView)findViewById(R.id.question5);
        ...
        mconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(manswer4.isChecked()){
                    ...
                    mscore.setText("YOU EARNED: $10,000");

                    Toast.makeText(getApplicationContext(), "Correct answer", Toast.LENGTH_LONG).show();
                    String scr=mscore.getText().toString();
                    Intent intent = new Intent(question5.this,question6.class);

                    intent.putExtra("YOU EARNED: $10,000",scr);
                    ...
                    Intent intent = new Intent(question5.this,gameOver.class);
                    String scr=mscore.getText().toString();
