...
public class question7 extends AppCompatActivity {
    ...
    private TextView mscore, mquestion7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mscore.setText(getIntent().getStringExtra("YOU EARNED: $25,000"));
        mquestion7=(TextView)findViewById(R.id.question7);
        ...
        mconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(manswer2.isChecked()){
                    ...
                    mscore.setText("YOU EARNED: $50,000");

                    Toast.makeText(getApplicationContext(), "Correct answer", Toast.LENGTH_LONG).show();
                    String scr=mscore.getText().toString();
                    Intent intent = new Intent(question7.this,question8.class);

                    intent.putExtra("YOU EARNED: $50,000",scr);
                    ...
                    Intent intent = new Intent(question7.this,gameOver.class);
                    String scr=mscore.getText().toString();
