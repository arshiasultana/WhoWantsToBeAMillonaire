...
public class question8 extends AppCompatActivity {
    ...
    private TextView mscore, mquestion8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mscore.setText(getIntent().getStringExtra("YOU EARNED: $50,000"));
        mquestion8=(TextView)findViewById(R.id.question8);
        ...
        mconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(manswer1.isChecked()){
                    ...
                    mscore.setText("YOU EARNED: $1,00,000");

                    Toast.makeText(getApplicationContext(), "Correct answer", Toast.LENGTH_LONG).show();
                    String scr=mscore.getText().toString();
                    Intent intent = new Intent(question8.this,question9.class);

                    intent.putExtra("YOU EARNED: $1,00,000",scr);
                    ...
                    Intent intent = new Intent(question8.this,gameOver.class);
                    String scr=mscore.getText().toString();
